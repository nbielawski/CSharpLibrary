...
namespace _0._12_Game
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Ahh... a {inputSpecialization}, an intersting choice.");
            ...
            Console.WriteLine($"You are going down {newHero.Name}");
            synth.Speak($"You are going down {newHero.Name}, the {newHero.Name}.");
            Thread.Sleep(1000);
